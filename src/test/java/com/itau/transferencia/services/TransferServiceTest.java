...
class TransferServiceTest {
    ...
    void transfer() {
        ...
        var transferRequest = new com.itau.transferencia.dtos.request.TransferDTO(destinationAccount, amount);
    ...
    void transferFailsWhenSameAccount() {
        ...
        var transferRequest = new com.itau.transferencia.dtos.request.TransferDTO(account, BigDecimal.valueOf(50));
    ...
    void getTransfers() {
        ...
        List<TransferDTO> result = service.getTransfers(account);
